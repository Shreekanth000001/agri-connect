export default function Footer() {
    return (
        <footer className="bg-neutral-primary-soft  bottom-0 ">
            <div className="mx-auto w-full max-w-7xl p-4 py-6 lg:py-8">
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        <a href="https://flowbite.com/" className="flex items-center">
                            <img src="https://flowbite.com/docs/images/logo.svg" className="h-7 me-3" alt="FlowBite Logo" />
                            <span className="text-heading self-center text-2xl font-semibold whitespace-nowrap">Agri Connect</span>
                        </a>
                    </div>
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        <div>
                            ...
                            <ul className="text-body font-medium">
                                <li className="mb-4">
                                    <a href="https://flowbite.com/" className="hover:underline">Agri Connect</a>
                                </li>
                                <li>
                        ...
                        <div>
                            ...
                            <ul className="text-body font-medium">
                                <li className="mb-4">
                                    <a href="https://github.com/Shreekanth000001" className="hover:underline ">Github</a>
                                </li>
                                <li>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-body sm:text-center">© 2026 <a href="https://flowbite.com/" className="hover:underline">Agri Connect™</a>. All Rights Reserved.
                    </span>
